Ext.define('VRU.view.cards.RecordSearchPanel', {
...
//                }, 
                {
                    ...
                    glyph: '54@fontello',
                    handler: function () {
                        Ext.ComponentQuery.query('searchpanel')[0].getForm().reset();
                        Ext.ComponentQuery.query('searchpanel grid')[0].getSelectionModel().deselectAll();
                        Ext.ComponentQuery.query('searchpanel grid')[1].getSelectionModel().deselectAll();
                    }
                }
            ]
        }
